...
export declare type Sala2OverridesProps = {
    Sala2?: PrimitiveOverrideProps<FlexProps>;
...
export declare type Sala2Props = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: Sala2OverridesProps | undefined | null;
}>;
export default function Sala2(props: Sala2Props): React.ReactElement;
