...
export declare type Sala3OverridesProps = {
    Sala3?: PrimitiveOverrideProps<FlexProps>;
...
export declare type Sala3Props = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: Sala3OverridesProps | undefined | null;
}>;
export default function Sala3(props: Sala3Props): React.ReactElement;
