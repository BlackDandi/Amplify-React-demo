...
export declare type Sala4OverridesProps = {
    Sala4?: PrimitiveOverrideProps<FlexProps>;
...
export declare type Sala4Props = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: Sala4OverridesProps | undefined | null;
}>;
export default function Sala4(props: Sala4Props): React.ReactElement;
