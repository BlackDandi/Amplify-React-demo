...
export declare type Sala5OverridesProps = {
    Sala5?: PrimitiveOverrideProps<FlexProps>;
...
export declare type Sala5Props = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: Sala5OverridesProps | undefined | null;
}>;
export default function Sala5(props: Sala5Props): React.ReactElement;
