...
export declare type Sala6OverridesProps = {
    Sala6?: PrimitiveOverrideProps<FlexProps>;
...
export declare type Sala6Props = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: Sala6OverridesProps | undefined | null;
}>;
export default function Sala6(props: Sala6Props): React.ReactElement;
