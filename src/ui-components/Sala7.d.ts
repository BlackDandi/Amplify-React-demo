...
export declare type Sala7OverridesProps = {
    Sala7?: PrimitiveOverrideProps<FlexProps>;
...
export declare type Sala7Props = React.PropsWithChildren<Partial<FlexProps> & {
    overrides?: Sala7OverridesProps | undefined | null;
}>;
export default function Sala7(props: Sala7Props): React.ReactElement;
